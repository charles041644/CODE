...
plt.subplot(122)
plt.imshow(img_gray/2+2*C*(C >= 0.4), cmap='gnuplot')
...
"""
"""
# C = img_gray/2+2*C*(C >= 0.4)
rotate_img=rotate(C,30)
cv2.imwrite("rotate_img1",rotate_img)
